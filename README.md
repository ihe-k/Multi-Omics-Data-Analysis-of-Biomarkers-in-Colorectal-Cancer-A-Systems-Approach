...
📌 Focus: Molecular and systems-level stratification of CRC patients 🧠 Themes: Cancer genomics, precision medicine, misinformation, systems health modelling 🧭 Core Methods: PCA, MDS, hierarchical clustering, t-tests, logistic regression, bootstrapping
